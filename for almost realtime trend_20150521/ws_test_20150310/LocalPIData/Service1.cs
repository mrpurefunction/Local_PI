        ...
        public void hisfn()
        {
            ...
            while (1 == 1)
            {
                ...
                else
                {
                    ...
                    (new Biz()).HistoryBiz(DateTime.Parse(DateTime.Now.AddHours(-1.0).ToString("yyyy-MM-dd HH:mm:00")), DateTime.Parse(DateTime.Now.AddMinutes(-15).ToString("yyyy-MM-dd HH:mm:00")));
