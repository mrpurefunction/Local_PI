        ...
        public void hisfn()
        {
            ...
            while (1 == 1)
            {
                ...
                else
                {
                    ...
                    (new Biz()).HistoryBiz(DateTime.Parse(DateTime.Now.AddHours(-1.0).ToString("yyyy-MM-dd HH:00:00")), DateTime.Parse(DateTime.Now/*.AddDays(-1)*/.AddMinutes(-15).ToString("yyyy-MM-dd HH:mm:00")));
